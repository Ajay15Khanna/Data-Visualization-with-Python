...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        figure=px.bar(average_sales, 
                x='unemployment_rate',
                y='Automobile_Sales',
                title="The effect of of unemployment rate on vehicle type sales during recession"))
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        values='Advertising_Expenditure',
        names='Vehicle_Type',
        title='Advertising expenditure for each vehicle type during {}'.format(input_year)))
